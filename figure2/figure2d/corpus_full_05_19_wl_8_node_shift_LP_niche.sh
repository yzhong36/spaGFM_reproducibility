...
#SBATCH -o corpus_full_05_19_wl_8_node_shift_LP_niche.out
#SBATCH -e corpus_full_05_19_wl_8_node_shift_LP_niche.out
...
echo "Processing corpus_full_317M_05_19_wl_${wl} with node shift noise"
...
--embedding-dir $file_path/corpus_full_317M_05_19_wl_${wl}_node_shift \
--save-path $file_path/corpus_full_317M_05_19_wl_${wl}_node_shift_LP_model_niche \
