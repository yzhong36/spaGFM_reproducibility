...
save_path='/users/yzhong36/data_wfairbro/yzhong36/spatial_foundation/scripts/CosMx/CosMx_Liver_benchmark/baseline_dir/nicheformer_emb'
os.makedirs(save_path, exist_ok=True)
adata=sc.read("/users/yzhong36/data_wfairbro/yzhong36/spatial_foundation/datasets/CosMx/CosMx_Human_Liver.h5ad")
...
for subset_name in adata.obs["Run_Tissue_name"].unique():
    ...
    adata_subset = adata_subset[:, adata_subset.var_names.isin(model_means.var_names)]
