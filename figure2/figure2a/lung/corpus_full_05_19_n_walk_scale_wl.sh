...
#SBATCH -o corpus_full_05_19_n_walk_scale_wl.out
#SBATCH -e corpus_full_05_19_n_walk_scale_wl.out
...
for n_walk in 16 32 64 128; do
    ...
    --save-path $output_path/corpus_full_${i}_05_19_wl_${wl}_n_walk_${n_walk} \
    --gpu-id 0 \
    --walk-length $wl \
    --n-total-rw $n_walk \
    --batch-size 128 \
