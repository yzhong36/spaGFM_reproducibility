...
save_path='/users/yzhong36/data_wfairbro/yzhong36/spatial_foundation/scripts/CosMx/CosMx_Lung_benchmark/baseline_dir/novae_emb/'
...
for subset_name in adata.obs["Run_Tissue_name"].unique():
    ...
    adata_coord = adata_subset.obs[['raw_sdimx', 'raw_sdimy']].values
