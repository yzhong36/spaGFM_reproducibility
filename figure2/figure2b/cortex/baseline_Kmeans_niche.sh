...
#SBATCH -o baseline_Kmeans_niche.out
#SBATCH -e baseline_Kmeans_niche.out
#SBATCH --cpus-per-task=5
#SBATCH --time=10:00:00
#SBATCH --mem=100gb
#SBATCH --account PAS1475

file_path='/fs/ess/PAS1475/yzhong/sf_project/backup/ccv/scripts/CosMx/CosMx_Cortex_benchmark/baseline_dir'
save_path='/fs/ess/PAS1475/yzhong/sf_project/scripts/CosMx_Cortex_benchmark/baseline_dir/05_19_26'
...
do
    if [ "$base_model" == "nicheformer_emb" ]; then
        ...
        --save-path $save_path/${base_model}_Kmeans_model_niche \
        --output-suffix .h5ad \
        --method kmeans_node \
        --dataset-attr Run_Tissue_name \
        --label-attr spatialClusteringAssignments \
